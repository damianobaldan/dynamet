#' TEST VERSION - Simulate Metacommunity Dynamics via Coalescent Assembly and lottery Phases
#'
#' @description
...
#'
masterEqMetacomm_test <- function(Meta.pool, Js, M.migra, m.pool, d.spp = NULL,
